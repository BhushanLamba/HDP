...
import classes.it.hdp.adapters.RechargeReportAdapter;
import classes.it.hdp.models.RechargeReportModel;
...
public class RechargeReportActivity extends AppCompatActivity {
    ...
    private void getReport() {
        ...
        Call<JsonObject> call = RetrofitClient.getInstance().getApi().getRechargeReport(userId,
                    ...
                    try {
                        ...
                        if (statusCode.equalsIgnoreCase("SUCCESS")) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                operatorName = jsonObject.getString("ProdName");
                                mobileNo = jsonObject.getString("CustomerNumber");
                                amount = jsonObject.getString("Amount");
                                commission = jsonObject.getString("RetailerCommission");
                                closingBalance = jsonObject.getString("BalBefore");
                                openingBalance = jsonObject.getString("BalAfter");
                                date = jsonObject.getString("TimeStamp");
                                status = jsonObject.getString("Status");
                                serviceType = jsonObject.getString("ProdName");
