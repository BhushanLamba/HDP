...
public class ShareAepsReportActivity extends AppCompatActivity {
    ...
    TextView tvTransactionId, tvTransactionType, tvOldBalance, tvNewBalance, tvAadharNo, tvPanNo, tvBankName,
            tvCommission, tvSurcharge, tvAmount, tvShopDetails, tvStatus,tvDateTime;
    AppCompatButton btnShare;
    String transactionId, transactionType, oldBalance, newBalance, aadharNo, panNo,
            bankName, commission, surcharge, amount, status,dateTime;
    ...
    private void setViews() {
        ...
        //TODO: change this transaction type
        if (transactionType.contains("Mini")) {
            tvTransactionType.setText("Mini Statement");
        }
        else if (transactionType.contains("Cash withdrawal")) {
